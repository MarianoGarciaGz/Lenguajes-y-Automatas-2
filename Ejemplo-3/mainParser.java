// $ANTLR 3.5.2 .\\main.g 2024-02-08 11:28:00
...
public class mainParser extends Parser {
	...
	public final void id() throws RecognitionException {
		...
		try {
			...
			// .\\main.g:13:11: ID
			{
			ID1=(Token)match(input,ID,FOLLOW_ID_in_id40); 
			System.out.println("ID reconocido: " + (ID1!=null?ID1.getText():null));
			}
	...
	public static final BitSet FOLLOW_ID_in_id40 = new BitSet(new long[]{0x0000000000000002L});
}
